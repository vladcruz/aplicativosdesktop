    ...
    static void ExecutarOperacao(string tipoOperacao)
    {
        ...
        if (tipoOperacao == "Inserir")
        {
            ...
            else if (pos == "3")
            {
                ...
                {
                    itens[indice].AddAfterSelf(novoItem); // Inserimos o novo nó, antes do nó de referência
                }
                else
                {
                    itens[indice].AddBeforeSelf(novoItem); // Inserimos o novo nó, após o nó de referência
                }
            }
        }
